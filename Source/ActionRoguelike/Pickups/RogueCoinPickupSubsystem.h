...
public:
	void AddCoinPickups(TArray<FVector> NewLocation, TArray<int32> NewAmounts);
	
	void Tick(float DeltaTime) override;
	virtual TStatId GetStatId() const override
	{
		RETURN_QUICK_DECLARE_CYCLE_STAT(FBehaviorTreeEditorTickHelper, STATGROUP_Tickables); 
	}
protected:
